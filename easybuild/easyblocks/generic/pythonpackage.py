...
def det_installed_python_packages_with_path(names_only=True, python_cmd=None, path=None):
    """
    ...
    """
    log = fancylogger.getLogger('det_installed_python_packages_with_path', fname=False)
...
class PythonPackage(ExtensionEasyBlock):
    ...
    def get_installed_python_packages(self, names_only=True, python_cmd=None, path=None):
        ...
        return det_installed_python_packages_with_path(names_only=names_only, python_cmd=python_cmd, path=path)
